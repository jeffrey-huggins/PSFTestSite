...
namespace AtriumWebApp.Web.ASAP
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ASAPHotlineContext>(_ => new ASAPHotlineContext(Configuration.GetConnectionString("database")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.EnvironmentName == "Development")
            {
                app.UseMvc(routes =>
                {
                    routes.MapRoute(
                        name: "default",
                        template: "CEA_TST/ASAP/{controller=Home}/{action=Index}/{id?}");
                });
            }
            else
            {
