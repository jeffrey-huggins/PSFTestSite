...
namespace AtriumWebApp.Web.ClinicalOps.Models
{
    public class SOCContext : SharedContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SOCEventWoundNoted>().Property(w => w.LengthNbr).HasColumnName("PWLengthNbr").HasPrecision(3,1);
            modelBuilder.Entity<SOCEventWoundNoted>().Property(w => w.WidthNbr).HasColumnName("PWWidthNbr").HasPrecision(3,1);
            modelBuilder.Entity<SOCEventWoundNoted>().Property(w => w.DepthNbr).HasColumnName("PWDepthNbr").HasPrecision(3,1);
